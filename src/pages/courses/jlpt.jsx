          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl">
                ...
                test. Whether you're aiming for N5 basics or the prestige of N1,
                our expert instructors guide you through every level with proven methods.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                authorities worldwide. Tests are held twice a year (July and December).
              </p>
            </div>
