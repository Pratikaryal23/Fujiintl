        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-5">
                One of NAT-TEST's biggest advantages over JLPT is its frequency —
                offered 6 times per year (every odd month), giving learners more
                opportunities to attempt and pass the exam quickly.
              </p>

              <p className="text-gray-700 leading-relaxed">
                It is recognized by many Japanese employers and immigration offices
                as valid proof of Japanese ability, especially at N3–N1 levels.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h4 className="text-2xl font-bold mb-6">{m.title}</h4>
