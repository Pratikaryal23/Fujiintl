...
export default function Gallery() {
  ...
  const renderImage = (image) => (
    <div
      key={image.id}
      className="w-40 sm:w-48 md:w-52 lg:w-56 h-56 md:h-64 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group cursor-pointer relative"
    >
      <img
        src={image.src}
        alt={image.alt}
  ...
  return (
    <section className="py-20 px-4 lg:px-12 bg-black">
      <div className="mt-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 leading-relaxed max-w-3xl mx-auto text-lg">
            ...
            studying, working, and building their future abroad with our
            guidance.
          </p>
        </div>
        ...
        <div className="block md:hidden mb-12">
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="flex w-full justify-center gap-4 px-2 flex-wrap">
