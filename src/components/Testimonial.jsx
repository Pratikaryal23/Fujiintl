      ...
      <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-y-12 md:gap-x-16">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-base sm:text-lg text-white/90 max-w-xl mx-auto md:mx-0 leading-relaxed">
            Our students share their journeys of learning, growth, and
            hands-on experience across our barista, bakery, bartending,
            and sushi-making programs.
          </p>
        </div>
        ...
        <div className="flex-1 w-full max-w-xl">
          ...
          {/* Card */}
          <div className="border-none bg-white/10 backdrop-blur-md shadow-2xl rounded-3xl">
